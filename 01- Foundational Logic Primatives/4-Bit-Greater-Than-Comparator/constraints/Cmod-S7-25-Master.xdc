...
set_property -dict { PACKAGE_PIN E1    IOSTANDARD LVCMOS33 } [get_ports { onboardLED }]; #IO_L8N_T1_34 Sch=led[4]
...
set_property -dict { PACKAGE_PIN L1    IOSTANDARD LVCMOS33 } [get_ports { externalLED }]; #IO_L18N_T2_34 Sch=pio[01]
...
set_property -dict { PACKAGE_PIN A2    IOSTANDARD LVCMOS33 } [get_ports { A0_4 }]; #IO_L2N_T0_34 Sch=pio[41]
set_property -dict { PACKAGE_PIN B2    IOSTANDARD LVCMOS33 } [get_ports { A1_4 }]; #IO_L2P_T0_34 Sch=pio[42]
set_property -dict { PACKAGE_PIN B1    IOSTANDARD LVCMOS33 } [get_ports { A2_4 }]; #IO_L4N_T0_34 Sch=pio[43]
set_property -dict { PACKAGE_PIN C1    IOSTANDARD LVCMOS33 } [get_ports { A3_4 }]; #IO_L4P_T0_34 Sch=pio[44]
set_property -dict { PACKAGE_PIN B3    IOSTANDARD LVCMOS33 } [get_ports { B0_4 }]; #IO_L3N_T0_DQS_34 Sch=pio[45]
set_property -dict { PACKAGE_PIN B4    IOSTANDARD LVCMOS33 } [get_ports { B1_4 }]; #IO_L3P_T0_DQS_34 Sch=pio[46]
set_property -dict { PACKAGE_PIN A3    IOSTANDARD LVCMOS33 } [get_ports { B2_4 }]; #IO_L1N_T0_34 Sch=pio[47]
set_property -dict { PACKAGE_PIN A4    IOSTANDARD LVCMOS33 } [get_ports { B3_4 }]; #IO_L1P_T0_34 Sch=pio[48]
