...
set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { duty_cycle_amt[3] }]; #IO_L8P_T1_D11_14 Sch=pio[30]
set_property -dict { PACKAGE_PIN J11   IOSTANDARD LVCMOS33 } [get_ports { duty_cycle_amt[2] }]; #IO_0_14 Sch=pio[31]
set_property -dict { PACKAGE_PIN C5    IOSTANDARD LVCMOS33 } [get_ports { duty_cycle_amt[1] }]; #IO_L5P_T0_34 Sch=pio[40]
set_property -dict { PACKAGE_PIN A2    IOSTANDARD LVCMOS33 } [get_ports { duty_cycle_amt[0] }]; #IO_L2N_T0_34 Sch=pio[41]
