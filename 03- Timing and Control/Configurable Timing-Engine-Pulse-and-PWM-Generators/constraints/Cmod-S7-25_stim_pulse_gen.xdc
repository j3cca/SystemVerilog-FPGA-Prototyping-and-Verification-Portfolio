...
set_property -dict { PACKAGE_PIN L14   IOSTANDARD LVCMOS33 } [get_ports { low_interval[3] }]; #IO_L7N_T1_D10_14 Sch=pio[26]
set_property -dict { PACKAGE_PIN K14   IOSTANDARD LVCMOS33 } [get_ports { low_interval[2] }]; #IO_L4P_T0_D04_14 Sch=pio[27]
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { low_interval[1] }]; #IO_L5P_T0_D06_14 Sch=pio[28]
set_property -dict { PACKAGE_PIN L13   IOSTANDARD LVCMOS33 } [get_ports { low_interval[0] }]; #IO_L7P_T1_D09_14 Sch=pio[29]
set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { high_interval[3] }]; #IO_L8P_T1_D11_14 Sch=pio[30]
set_property -dict { PACKAGE_PIN J11   IOSTANDARD LVCMOS33 } [get_ports { high_interval[2] }]; #IO_0_14 Sch=pio[31]
set_property -dict { PACKAGE_PIN C5    IOSTANDARD LVCMOS33 } [get_ports { high_interval[1] }]; #IO_L5P_T0_34 Sch=pio[40]
set_property -dict { PACKAGE_PIN A2    IOSTANDARD LVCMOS33 } [get_ports { high_interval[0] }]; #IO_L2N_T0_34 Sch=pio[41]
set_property -dict { PACKAGE_PIN B2    IOSTANDARD LVCMOS33 } [get_ports { sq_pulse }]; #IO_L2P_T0_34 Sch=pio[42]
